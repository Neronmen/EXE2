...
export class ChangePassProfileController {
  constructor(
    private readonly changePassProfileService: ChangePassProfileService,
  ) {}
  ...
  async changePass(
    ...
    @Body() data: ChangePassProfileDto,
    @GetUser() user,
  ) {
    console.log(userID);
    console.log(data);
    console.log(user);
    return await this.changePassProfileService.changePassProfile(
      Number(userID),
      data,
      user,
    );

    ...
    async deleteProduct(productId, user) {
        const [product, seller] = await Promise.all([
            this.prisma.product.findUnique({
                ...
                select: { id: true, isDeleted: true, sellerID: true },
            }),
        ...
        if (product.sellerID !== seller.id) {
            return (0, response_util_1.errorResponse)(400, 'Bạn không có quyền xóa sản phẩm này', 'FORBIDDEN');
        }
        const updated = await this.prisma.product.update({
            where: { id: productId },
            data: { isDeleted: !product.isDeleted },
        });
        return (0, response_util_1.successResponse)(200, "Xóa sản phẩm thành công");
    }
};
exports.DeleteProductService = DeleteProductService;
exports.DeleteProductService = DeleteProductService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], DeleteProductService);
//# sourceMappingURL=delete-product.service.js.map
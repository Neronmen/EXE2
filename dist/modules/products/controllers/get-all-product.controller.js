...
const get_all_product_query_1 = require("../dtos/get-all-product.query");
let GetAllProductController = class GetAllProductController {
    getAllProductService;
    constructor(getAllProductService) {
        this.getAllProductService = getAllProductService;
    }
    async getAllProduct(query, user) {
        console.log(query);
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.GET_ALL_PRODUCT.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(4),
    (0, common_1.Get)(app_routes_1.routesV1.product.createProduct),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_all_product_query_1.GetAllProductQueryDto, Object]),
    __metadata("design:returntype", Promise)
], GetAllProductController.prototype, "getAllProduct", null);
exports.GetAllProductController = GetAllProductController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.GET_ALL_PRODUCT.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [get_all_product_service_1.GetAllProductService])
], GetAllProductController);
//# sourceMappingURL=get-all-product.controller.js.map
...
let UpdateProductController = class UpdateProductController {
    ...
    async updateProduct(productId, dto, user) {
        return this.updateProductService.updateProduct(productId, dto, user.id);
    }
};
exports.UpdateProductController = UpdateProductController;
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.UPDATE_PRODUCT.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(4),
    (0, common_1.Patch)(app_routes_1.routesV1.product.getDetailProduct),
...
], UpdateProductController.prototype, "updateProduct", null);
exports.UpdateProductController = UpdateProductController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.UPDATE_PRODUCT.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [update_product_service_1.UpdateProductService])

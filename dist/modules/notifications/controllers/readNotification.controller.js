...
let ReadNotificationController = class ReadNotificationController {
    ...
    constructor(readNotificationService) {
        this.readNotificationService = readNotificationService;
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.READ_NOTIFICATION.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard),
    (0, common_1.Patch)(app_routes_1.routesV1.notification.readUserNotifications),
    __param(0, (0, common_1.Param)('notificationID')),
    __param(1, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ReadNotificationController.prototype, "readNotification", null);
exports.ReadNotificationController = ReadNotificationController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.READ_NOTIFICATION.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [readNotification_service_1.ReadNotificationService])
], ReadNotificationController);
//# sourceMappingURL=readNotification.controller.js.map
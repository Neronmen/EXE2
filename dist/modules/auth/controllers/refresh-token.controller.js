...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.REFRESH.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(refresh_guard_1.RefreshGuard),
    (0, common_1.Post)(app_routes_1.routesV1.auth.refresh),
...
exports.RefreshController = RefreshController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.REFRESH.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [refresh_token_service_1.RefreshService])
], RefreshController);

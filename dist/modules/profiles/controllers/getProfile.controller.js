...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.GET_PROFILE.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard),
    (0, common_1.Get)(app_routes_1.routesV1.profile.root),
    __param(0, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GetProfileController.prototype, "getProfile", null);
exports.GetProfileController = GetProfileController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.GET_PROFILE.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [getProfile_service_1.GetProfileService])

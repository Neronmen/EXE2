...
let DeleteCategoryController = class DeleteCategoryController {
    ...
    constructor(DeleteCategoryGlobalService) {
        this.DeleteCategoryGlobalService = DeleteCategoryGlobalService;
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.DELETE_CATEGORY_GLOBAL.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(1, 2),
    (0, common_1.Delete)(app_routes_1.routesV1.categoryGlobal.getOne),
    __param(0, (0, common_1.Param)("id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DeleteCategoryController.prototype, "DeleteCategoryGlobal", null);
exports.DeleteCategoryController = DeleteCategoryController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.DELETE_CATEGORY_GLOBAL.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [delete_category_global_service_1.DeleteCategoryGlobalService])
], DeleteCategoryController);
//# sourceMappingURL=delete-category-global.controller.js.map
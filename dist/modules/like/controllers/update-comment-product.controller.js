...
const update_product_comment_dto_1 = require("../dtos/update-product-comment.dto");
...
let UpdateCommentController = class UpdateCommentController {
    ...
    constructor(updateCommentService) {
        this.updateCommentService = updateCommentService;
    }
    async updateComment(commentId, dto, files, user) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.UPDATE_COMMENT_PRODUCT.displayName }),
    ...
    (0, common_1.Patch)(app_routes_1.routesV1.comment.updateComment),
    __param(0, (0, common_1.Param)('commentId')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.UploadedFiles)()),
    __param(3, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_product_comment_dto_1.UpdateProductCommentDto, Object, Object]),
    __metadata("design:returntype", Promise)
], UpdateCommentController.prototype, "updateComment", null);
exports.UpdateCommentController = UpdateCommentController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.UPDATE_COMMENT_PRODUCT.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [update_comment_product_service_1.UpdateProductCommentService])
], UpdateCommentController);
//# sourceMappingURL=update-comment-product.controller.js.map
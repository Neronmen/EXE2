...
let UpdateAddressController = class UpdateAddressController {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.UPDATE_ADDRESS.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard),
    (0, common_1.Put)(app_routes_1.routesV1.adddress.getOne),
...
], UpdateAddressController.prototype, "update", null);
exports.UpdateAddressController = UpdateAddressController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.UPDATE_ADDRESS.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [updateAddress_service_1.UpdateAddressService])

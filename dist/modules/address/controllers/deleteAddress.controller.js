...
let DeleteAddressController = class DeleteAddressController {
    DeleteAddressService;
    constructor(DeleteAddressService) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: app_permission_1.resourcesV1.DELETE_ADDRESS.displayName }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_guard_1.JWTGuard),
    (0, common_1.Delete)(app_routes_1.routesV1.adddress.getOne),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], DeleteAddressController.prototype, "Delete", null);
exports.DeleteAddressController = DeleteAddressController = __decorate([
    (0, swagger_1.ApiTags)(`${app_permission_1.resourcesV1.DELETE_ADDRESS.parent}`),
    (0, common_1.Controller)(app_routes_1.routesV1.apiversion),
    __metadata("design:paramtypes", [deleteAddress_service_1.DeleteAddressService])

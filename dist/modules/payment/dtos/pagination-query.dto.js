...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, default: 0, description: 'Số mục bỏ qua' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, default: 10, description: 'Số mục cần lấy' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),

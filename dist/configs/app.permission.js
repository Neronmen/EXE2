...
exports.resourcesV1 = {
    ...
    LOGIN_FACEBOOK: {
        name: 'Login Facebook',
        displayName: 'Login Facebook- Khoa',
        parent: 'Auth',
    },
    SIGNUP: {
        name: 'Signup',
        displayName: 'Signup - Khoa',
        parent: 'Auth',
    },
    REFRESH: {
        name: 'Refresh',
        displayName: 'Refresh - Khoa',
        parent: 'Auth',
    },
    FORGOT_PASWORD: {
        name: 'Forgot Password',
        displayName: 'Forgot Password - Khoa',
        parent: 'Auth',
    },
    VERIFY_OTP: {
        name: 'Verify OTP',
        displayName: 'Verify OTP - Khoa',
        parent: 'Auth',
    },
    RESET_PASSWORD: {
        name: 'Reset Password',
        displayName: 'Reset Password - Khoa',
        parent: 'Auth',
    },
    RESEND_OTP: {
        name: 'Resend OTP',
    ...
    UPDATE_PERMISSION_BY_ROLE: {
        name: 'Update Permission By Role',
